shared_examples 'profile::activemq' do
  ...
  describe file('/opt/activemq/conf/activemq.xml') do
    ...
    its(:content) { should include '<networkConnector name="connector-bridge"  uri="static:(tcp://activemq-broker-new.localdomain:61616)" userName="networkconnuser" password="networkconnpassword" />' }
  end
